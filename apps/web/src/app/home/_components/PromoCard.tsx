...
export function PromoCard({ promo }: { promo: Promo }) {
  ...
  return (
    <div style={{ padding: `${SPACE[4]}px ${SPACE[3]}px`, borderBottom: `1px solid ${COLOR.hairline}` }}>
      <div style={{ background: COLOR.surface, borderRadius: RADIUS.lg, padding: SPACE[4], display: 'flex', flexDirection: 'column', gap: SPACE[2] }}>
