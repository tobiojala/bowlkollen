...
export const MOCK_HONOR: HonorEntry[] = [
  ...
  { playerName: 'Tobias Bergmark', score: 279, matchId: 'demo-r-1' },
...
export const MOCK_TABLES: Record<string, TableRow[]> = {
  'Allsvenskan Herrar': [
    { rank: 1, teamId: 'demo-t17', teamName: 'Sundsvalls BK',     played: 10, won: 8, drawn: 1, lost: 1, points: 26, form: ['W','W','W','D','W'] },
    { rank: 2, teamId: 'demo-t18', teamName: 'Skövde BK',         played: 10, won: 7, drawn: 0, lost: 3, points: 22, form: ['W','L','W','W','L'] },
    { rank: 3, teamId: 'demo-t19', teamName: 'IFK Göteborg BK',   played: 10, won: 6, drawn: 1, lost: 3, points: 20, form: ['W','D','W','L','W'] },
    { rank: 4, teamId: 'demo-t3',  teamName: 'Göteborgs BK',      played: 10, won: 5, drawn: 2, lost: 3, points: 18, form: ['D','W','L','W','D'] },
    { rank: 5, teamId: 'demo-t20', teamName: 'Västervik BK',      played: 10, won: 5, drawn: 0, lost: 5, points: 15, form: ['L','W','W','L','L'] },
    { rank: 6, teamId: 'demo-t21', teamName: 'Nacka BK',          played: 10, won: 3, drawn: 2, lost: 5, points: 11, form: ['L','D','L','W','L'] },
    { rank: 7, teamId: 'demo-t22', teamName: 'Trollhättans BK',   played: 10, won: 2, drawn: 1, lost: 7, points: 8,  form: ['L','L','W','L','L'] },
    { rank: 8, teamId: 'demo-t23', teamName: 'Uddevalla BK',      played: 10, won: 1, drawn: 0, lost: 9, points: 3,  form: ['L','L','L','L','W'] },
  ],
  'Elitserien Herrar': [
    { rank: 1, teamId: 'demo-t1',  teamName: 'IK Hakarpspojkarna', played: 14, won: 11, drawn: 1, lost: 2,  points: 34, form: ['W','W','W','D','W'] },
    { rank: 2, teamId: 'demo-t2',  teamName: 'Mariestads BK',      played: 14, won: 10, drawn: 1, lost: 3,  points: 31, form: ['W','W','L','W','W'] },
    { rank: 3, teamId: 'demo-t3',  teamName: 'Göteborgs BK',       played: 14, won: 8,  drawn: 2, lost: 4,  points: 26, form: ['D','W','W','L','W'] },
    { rank: 4, teamId: 'demo-t4',  teamName: 'Linköpings BK',      played: 14, won: 7,  drawn: 1, lost: 6,  points: 22, form: ['L','W','D','W','L'] },
    { rank: 5, teamId: 'demo-t11', teamName: 'Örebro BK',          played: 14, won: 5,  drawn: 3, lost: 6,  points: 18, form: ['D','L','W','D','L'] },
    { rank: 6, teamId: 'demo-t12', teamName: 'Lidköpings BSK',     played: 14, won: 4,  drawn: 2, lost: 8,  points: 14, form: ['L','L','W','L','D'] },
    { rank: 7, teamId: 'demo-t13', teamName: 'Enköpings BS',       played: 14, won: 2,  drawn: 2, lost: 10, points: 8,  form: ['L','L','D','L','L'] },
    { rank: 8, teamId: 'demo-t14', teamName: 'Halmstad BK',        played: 14, won: 1,  drawn: 2, lost: 11, points: 5,  form: ['L','D','L','L','L'] },
  ],
  'Elitserien Damer': [
    { rank: 1, teamId: 'demo-t5',  teamName: 'Örebro BK',      played: 12, won: 9,  drawn: 2, lost: 1,  points: 29, form: ['W','W','D','W','W'] },
    { rank: 2, teamId: 'demo-t6',  teamName: 'Malmö BK',       played: 12, won: 8,  drawn: 1, lost: 3,  points: 25, form: ['W','L','W','W','W'] },
    { rank: 3, teamId: 'demo-t7',  teamName: 'Jönköpings BK',  played: 12, won: 7,  drawn: 2, lost: 3,  points: 23, form: ['D','W','W','L','W'] },
    { rank: 4, teamId: 'demo-t8',  teamName: 'Borås BK',       played: 12, won: 5,  drawn: 1, lost: 6,  points: 16, form: ['L','W','L','W','L'] },
    { rank: 5, teamId: 'demo-t9',  teamName: 'Halmstad BK',    played: 12, won: 4,  drawn: 2, lost: 6,  points: 14, form: ['D','L','L','W','D'] },
    { rank: 6, teamId: 'demo-t10', teamName: 'Helsingborg BK', played: 12, won: 3,  drawn: 1, lost: 8,  points: 10, form: ['L','L','W','L','L'] },
    { rank: 7, teamId: 'demo-t15', teamName: 'Sollentuna BK',  played: 12, won: 2,  drawn: 1, lost: 9,  points:  7, form: ['L','D','L','L','L'] },
    { rank: 8, teamId: 'demo-t16', teamName: 'Uppsala BK',     played: 12, won: 1,  drawn: 0, lost: 11, points: 3,  form: ['L','L','L','W','L'] },
  ],
}

export const MOCK_MY_PLAYER = {
  name: 'Tobias Bergmark',
  team: 'Göteborgs BK',
  teamId: 'demo-t3',
