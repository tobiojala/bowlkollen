...
// State machine for logging a game via the pin deck. Each ball you tap the pins
// left STANDING; pinfall is derived, the game is scored by @bowlkollen/core, and
// open frames' leaves are captured for Spärranalys. Frames 1–9 log leaves; the
// 10th only scores (bonus balls handled, no leave capture).
