...
export default function LaguttagningPage({ params }: Props) {
  ...
  if (loading) return <div style={{ minHeight: '100vh', background: bg, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'system-ui', color: muted }}>Laddar...</div>
  ...
  return (
    <div style={{ minHeight: '100vh', background: bg, color: text, fontFamily: 'system-ui, sans-serif', paddingBottom: splitMode ? 0 : 80 }}>
