...
const styles = StyleSheet.create({
  ...
  h2hNum: { color: COLOR.ink3, fontSize: TYPE.hero - 8, fontFamily: FONT.display, fontVariant: ['tabular-nums'] },
  h2hWin: { color: COLOR.green },
  h2hDash: { color: COLOR.ink4, fontSize: TYPE.title, fontFamily: FONT.display, marginHorizontal: SPACE[3] },
  ...
  val: { flex: 1, fontSize: TYPE.title, fontFamily: FONT.display, fontVariant: ['tabular-nums'], textAlign: 'center' },
