...
function FeatureCard({ feature, index }: { feature: typeof FEATURES[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      whileHover={{ borderColor: `${feature.accent}30`, boxShadow: `0 0 24px ${feature.accent}08` }}
      style={{
        padding: '20px 18px',
    ...
    >
      ...
      <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: 1.5, color: feature.accent, textTransform: 'uppercase', marginBottom: 5, opacity: 0.6 }}>
        {feature.label}
      </div>
    ...
    >
      ...
      <motion.div
        style={{
          ...
          background: 'linear-gradient(90deg, #f5c200, #ffdd57)',
          transformOrigin: '0%',
      ...
      <div style={{ position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 0, overflow: 'hidden' }}>
        <motion.div
          ...
          style={{
            ...
            background: 'radial-gradient(ellipse, rgba(245,194,0,0.065) 0%, transparent 65%)',
            borderRadius: '50%',
          }}
        />
        <motion.div
          ...
          style={{
            ...
            background: 'radial-gradient(ellipse, rgba(90,130,180,0.06) 0%, transparent 65%)',
            borderRadius: '50%',
          }}
        />
        <motion.div
          ...
          style={{
            ...
            background: 'radial-gradient(ellipse, rgba(93,202,165,0.04) 0%, transparent 65%)',
            borderRadius: '50%',
          }}
        />
      </div>
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 560, margin: '0 auto', padding: '0 22px' }}>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <div style={{ width: 26, height: 26, background: '#f5c200', borderRadius: 6, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#000" strokeWidth="2.5" strokeLinecap="round">
                <circle cx="12" cy="12" r="10"/>
                <circle cx="8.5" cy="9.5" r="1.5" fill="#000" stroke="none"/>
                <circle cx="14" cy="7" r="1.5" fill="#000" stroke="none"/>
                <circle cx="15" cy="13.5" r="1.5" fill="#000" stroke="none"/>
              </svg>
            </div>
        ...
        <div style={{ paddingTop: 72, paddingBottom: 72 }}>
          ...
          >
            ...
            <span style={{ fontSize: 12, fontWeight: 500, color: 'rgba(255,255,255,0.28)', letterSpacing: 0.1 }}>
        ...
        >
          <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: 2.2, color: 'rgba(255,255,255,0.2)', textTransform: 'uppercase', marginBottom: 8 }}>
            Det saknas i dag
          </div>
          <div style={{ fontSize: 'clamp(18px, 3.5vw, 22px)', fontWeight: 800, color: '#fff', letterSpacing: -0.6, lineHeight: 1.2 }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            {SOCIALS.map(s => (
              <motion.a
                ...
                aria-label={s.name}
                whileHover={{ borderColor: 'rgba(255,255,255,0.18)', color: 'rgba(255,255,255,0.65)' }}
                whileTap={{ scale: 0.93 }}
                style={{
