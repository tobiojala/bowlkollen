    ...
    <main style={{ minHeight: '100vh', background: C.bg, color: C.text, fontFamily: 'system-ui, sans-serif', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ width: '100%', maxWidth: 360, padding: '0 24px' }}>
        ...
        <button
          ...
          disabled={loading}
          style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, background: C.card, border: '1px solid ' + C.border, borderRadius: 12, padding: '14px 20px', fontSize: 15, fontWeight: 600, color: C.text, cursor: loading ? 'not-allowed' : 'pointer', opacity: loading ? 0.7 : 1, marginBottom: 16 }}
        >
          {!loading && (
