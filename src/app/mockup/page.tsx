...
import { MATCHES, LAST_SEASON, ELITSERIEN_BK_RATINGS, PLAYER_BK_RATING } from './data'
...
export default function MockupPage() {
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#10161e', fontFamily: 'system-ui, sans-serif', color: 'white' }}>
      {/* Barlow Condensed font for .num */}
      <style>{`@import url('https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@700;900&display=swap');`}</style>

      {/* Depth layer — blurs and recedes when a toast/sheet is visible */}
      <div style={{
