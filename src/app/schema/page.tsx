  ...
  const TavCard = ({ t }: { t: Tavling }) => {
    ...
    return (
      <div style={{ margin: '8px 8px 4px', borderRadius: 14, overflow: 'hidden',
        background: isDark
          ? isLive ? 'rgba(196,144,64,0.07)' : 'rgba(245,194,0,0.05)'
          : isLive ? 'rgba(196,144,64,0.04)' : 'rgba(245,194,0,0.03)',
        border: `1px solid ${isLive ? 'rgba(196,144,64,0.25)' : isDark ? 'rgba(245,194,0,0.15)' : 'rgba(245,194,0,0.2)'}` }}>
        <div style={{ height: 2, background: isLive
          ? `linear-gradient(90deg,${GREEN},rgba(196,144,64,0.2))`
